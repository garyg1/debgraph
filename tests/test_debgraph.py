...
def test_parser():
    tests = [
        ["apt-transport-https (= 3.2.0)", {"name": "apt-transport-https", "op": "=", "version": "3.2.0"}],
...
def _test_fixture(fixture: str):
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for expected_fixture, _ in out_fixtures:
            ...
            with open(actual_fixture, "r") as actual, open(expected_fixture, "r") as expected:
